...
Guidance for AI coding agents working in **eurosky-social-app**.
...
Sync AGENTS.md from zincfox; Sync CONTRIBUTING.md from zincfox; Sync AGENTS.md from zincfox; Sync CONTRIBUTING.md from zincfox; Rewrite README to describe Mu as a web-app-only fork by Eurosky